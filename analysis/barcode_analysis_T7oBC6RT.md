...
![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-3-2.png)<!-- -->
...
![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-3-3.png)<!-- -->

``` r
VlnPlot(dataCD4, c("p139-BC4","p139-BC5","p139-BC6"), group.by = "hash.ID", pt.size = 0, assay = "BC")
```

![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->

``` r
VlnPlot(dataSplen, "p139-BC6", pt.size = 0, assay = "BC")
```

![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->

``` r
VlnPlot(subset(dataSplen, !(subset = clusters_anno %in% c("5","10"))), "p139-BC6", pt.size = 0, assay = "BC")
```

![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
...
```
    ...
    ## Warning: Removed 1254 rows containing missing values or values outside the scale range
    ## (`geom_line()`).

    ## Warning: Removed 21 rows containing missing values or values outside the scale range
    ## (`geom_line()`).

    ## Warning: Removed 1336 rows containing missing values or values outside the scale range
    ## (`geom_line()`).

![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](barcode_analysis_T7oBC6RT_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
