...
Cluster 6 and 14 seem to be contaminating B cells. I will remove them in the
final dataset.

```{r}
dataCD4Sub <- subset(dataCD4, subset = seurat_clusters != "6" & seurat_clusters != "14")
...
metadata <- dataSplenocytes@meta.data %>%
  as_tibble() %>%
  mutate(clusters_anno = case_when(seurat_clusters %in% c("0","1","2","3","4") ~ "Bcells",
                                   seurat_clusters %in% c("5","9") ~ "Tcell",
                                   seurat_clusters %in% c("6","8") ~ "6_8",
                                   seurat_clusters == "7" ~ "NKcell",
                                   seurat_clusters == '10' ~ "10",
                                   seurat_clusters == "11" ~ "Macrophage",
...
```{r}
saveRDS(dataCD4Sub, "C:/Users/Eric/My Drive/Lab/datasets/EYW/SIG03_10x_240706/seurat_outs/SIG03_mouse_oBC_DirectAmp_CD4.rds")
saveRDS(dataSplenocytes, "C:/Users/Eric/My Drive/Lab/datasets/EYW/SIG03_10x_240706/seurat_outs/SIG03_mouse_oBC_DirectAmp_splenocytes.rds")
```
